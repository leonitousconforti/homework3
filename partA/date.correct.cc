...
/**
* Constructor
* param [in] year, month, day: integer values for candidate date's year, month, day respectively
*
* The easiest way to determine if the inputs are valid, is to convert to days and back.
**/
